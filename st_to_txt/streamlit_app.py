...
if uploaded_files:
    ...
    # 🖼 **Preview uploaded frames (immediately after upload)**
    ...
    st.write("✅ Frames saved. Ready to process!")

    # 🧠 **Run model after preview**
    ...
    if glosses:
        ...
        with st.spinner("⏳ Generating sentence and audio..."):
            ...
            print(f"⏳ Gloss-to-Text took {time.time() - start_time:.2f} seconds")
        ...
        # 🔥 **Delete frames after glosses are generated**
        ...
        #st.warning("🚮 Frames have been deleted to free up storage.")
